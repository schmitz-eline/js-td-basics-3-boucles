...
const tableMult = prompt('Je voudrais afficher les 10 premières valeurs de la table de multiplication par :');
console.log(`Voici les 10 premières valeurs de la table de multiplication par ${tableMult} :`);
for (let i = 1; i <= 10; i++) {
